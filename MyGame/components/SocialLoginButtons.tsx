        ...
        <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
                <motion.button
                    ...
                    disabled={!!isLoading}
                    className="flex items-center justify-center space-x-3 bg-white border-4 border-gray-100 rounded-2xl py-4 shadow-lg hover:border-candy-yellow transition-all group disabled:opacity-50"
                >
                ...
                <motion.button
                    ...
                    disabled={!!isLoading}
                    className="flex items-center justify-center space-x-3 bg-[#1877F2] border-4 border-white/20 rounded-2xl py-4 shadow-lg hover:shadow-[#1877F2]/30 transition-all group disabled:opacity-50"
                >
            ...
            <AnimatePresence>
                {error && (
                    <motion.div
                        ...
                        className="flex items-center gap-2 text-red-500 bg-red-50 p-3 rounded-2xl border border-red-100 mt-2"
                    >
